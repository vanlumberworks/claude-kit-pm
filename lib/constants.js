...
`,
  ...
  MCP_SERVERS: {
    'brave-search': {
      ...
      apiKeyName: 'braveKey',
      description: 'Brave Search API for research commands'
    },
    'perplexity': {
      required: false,
      command: 'npx',
      ...
      apiKeyName: 'perplexityKey',
      description: 'Perplexity API for enhanced research'
    },
    'gemini': {
      required: false,
      command: 'npx',
      ...
      description: 'Gemini API for multi-modal analysis'
    }
  },
